...
if __name__=="__main__":
    ...
    print 'training AdaBoost Classifier with 50 estimators'
    clf = AdaBoostClassifier(DecisionTreeClassifier(), algorithm='SAMME', n_estimators=100)
    ...
    for im_name in TEST_IMAGES:
        ...
        numpy.save(im_name+'_im_adaboost.npy', im_new)
        im_out = Image.fromarray(im_new)
        im_out.save(im_name+'_annotated_adaboost.png')
